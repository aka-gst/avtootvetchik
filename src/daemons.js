 ...
 * настройка, а ставка.
 *
 * Узоры AAA / ABA / ABC подсказаны KNB: Tactical Evolution — там они
 * работают в пошаговом обмене. Здесь у них другая цена и другой смысл:
...
/*
 * Узор очереди. Ровно то место, что подсказал KNB, — но здесь узнаются
 * и короткие очереди: игрок потратил время и должен получить ответ, даже
 * если набрал всего одну стихию.
 */
