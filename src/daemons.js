...
/*
 * Форма несёт все стихии своей очереди — по ним и решается, возьмёт ли
 * она носителя. Правило простое: своя стихия врага его не берёт. Огнём
 * по огненному — он её отобьёт, хоть три подряд, хоть одну. Нужен любой
 * другой цвет, и в смешанной очереди достаточно одного чужого.
 *
 * Никакого круга превосходств: «бей не тем, чем он светится» читается с
 * экрана без заучивания, а круг пришлось бы держать в голове.
 */
